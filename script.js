document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateEconomicsTable(ticket, opex, baseVol, taxRate, capexMid) {
        ...
        if (textContent) {
            ...
            const beDaily = (beMonthly / 30).toFixed(1);
            ...
            if (isJa) {
                bulletsHtml = `
                    <ul>
                        ...
                        <li><strong>売上総利益率:</strong> 90% (施術原価 ~USD ${cogsFmt}/セッション)</li>
                        <li><strong>1客あたり限界利益:</strong> USD ${contribFmt}</li>
                        <li><strong>月間損益分岐客数:</strong> USD ${opexFmt} (運営費) / USD ${contribFmt} = ~${beMonthly.toLocaleString()} 客/月</li>
                ...
                bulletsHtml = `
                    <ul>
                        ...
                        <li><strong>Tỷ suất lợi nhuận gộp:</strong> 90% (Giá vốn dịch vụ ~USD ${cogsFmt}/lượt)</li>
